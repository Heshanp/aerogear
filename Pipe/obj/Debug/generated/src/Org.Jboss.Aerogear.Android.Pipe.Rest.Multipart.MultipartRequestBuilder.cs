...
namespace Org.Jboss.Aerogear.Android.Pipe.Rest.Multipart {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.jboss.aerogear.android.pipe.rest.multipart']/class[@name='MultipartRequestBuilder']"
	[global::Android.Runtime.Register ("org/jboss/aerogear/android/pipe/rest/multipart/MultipartRequestBuilder", DoNotGenerateAcw=true)]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T"})]
	public partial class MultipartRequestBuilder : global::Java.Lang.Object, global::Org.Jboss.Aerogear.Android.Pipe.IRequestBuilder {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/jboss/aerogear/android/pipe/rest/multipart/MultipartRequestBuilder", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (MultipartRequestBuilder); }
		}

		protected MultipartRequestBuilder (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.jboss.aerogear.android.pipe.rest.multipart']/class[@name='MultipartRequestBuilder']/constructor[@name='MultipartRequestBuilder' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe MultipartRequestBuilder ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (MultipartRequestBuilder)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Org.Jboss.Aerogear.Android.Pipe.Rest.Multipart.MultipartRequestBuilder __this = global::Java.Lang.Object.GetObject<global::Org.Jboss.Aerogear.Android.Pipe.Rest.Multipart.MultipartRequestBuilder> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe string ContentType {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.jboss.aerogear.android.pipe.rest.multipart']/class[@name='MultipartRequestBuilder']/method[@name='getContentType' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Org.Jboss.Aerogear.Android.Pipe.MarshallingConfig MarshallingConfig {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.jboss.aerogear.android.pipe.rest.multipart']/class[@name='MultipartRequestBuilder']/method[@name='getMarshallingConfig' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='org.jboss.aerogear.android.pipe.rest.multipart']/class[@name='MultipartRequestBuilder']/method[@name='setMarshallingConfig' and count(parameter)=1 and parameter[1][@type='org.jboss.aerogear.android.pipe.MarshallingConfig']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.jboss.aerogear.android.pipe.rest.multipart']/class[@name='MultipartRequestBuilder']/method[@name='getBody' and count(parameter)=1 and parameter[1][@type='T']]"
