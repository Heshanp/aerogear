...
namespace Org.Jboss.Aerogear.Android.Core {
	...
	public partial interface IConfig : IJavaObject {
		...
		string Name {
			...
			[Register ("getName", "()Ljava/lang/String;", "GetGetNameHandler:Org.Jboss.Aerogear.Android.Core.IConfigInvoker, Core")] get;
		}
		...
		[Register ("setName", "(Ljava/lang/String;)Lorg/jboss/aerogear/android/core/Config;", "GetSetName_Ljava_lang_String_Handler:Org.Jboss.Aerogear.Android.Core.IConfigInvoker, Core")]
